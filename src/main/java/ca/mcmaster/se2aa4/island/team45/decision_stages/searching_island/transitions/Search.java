...
public interface Search {
    ...
    public static boolean atForwardEdge(
        ...
        CoordinateManager coordinateManager) {
            return islandEdgeManager.atEdge(
                ...
                directionManager.getDirection().getFullDirectionString());
    }
    ...
    public static boolean shiftFromSideEdge(
        ...
        CoordinateManager coordinateManager,
        int shiftValue) {
            return islandEdgeManager.atEdge(sideEdgeDirection.stringForward(), 
                    coordinateManager.getOffsetCoordinates(sideEdgeDirection, shiftValue), 
                    sideEdgeDirection.getFullDirectionString());
    }
